...
<div id="formSection">
        ...
        <?php
            ...
            if(isset($_SESSION['s_book'])){
                ...
                mysqli_stmt_bind_param($query, "s", $_SESSION['s_book']);
                ...
                echo "<p class='message'>You Selected: ".$_SESSION['s_book']."</p><p class='message'>Quantity Available: ".$_SESSION['s_quantity']."</p>";
                
                //checking if there is stock of the selected book by the user
                if($_SESSION['s_quantity'] > 0){
            ?>
                ...
                <form action="order.php" method="POST">
                    ...
                    <input type="number" name="quantity" id="quantity" min="1" max="<?php echo $_SESSION['s_quantity'] ?>">

                    <br>

                    <input type="submit" value="Purchase" class="toHome">
